...
public class OtherCompaniesFrgValues {

    @SerializedName("cmp_date_time")
    private String cmp_date_time;

    @SerializedName("cmp_uniq_id")
    private String cmp_uniq_id;

    @SerializedName("cmp_id")
    private String cmp_id;

    @SerializedName("cmp_candidate_view")
    private String cmp_candidate_view;

    @SerializedName("cmp_full_name")
    private String cmp_full_name;

    @SerializedName("cmp_contact")
    private String cmp_contact;

    @SerializedName("cmp_designation")
    private String cmp_designation;

    @SerializedName("cmp_email")
    private String cmp_email;

    @SerializedName("cmp_company_name")
    private String cmp_company_name;

    @SerializedName("cmp_head_office_location")
    private String cmp_head_office_location;

    @SerializedName("cmp_industry")
    private String cmp_industry;

    @SerializedName("cmp_company_category")
    private String cmp_company_category;

    @SerializedName("cmp_job_type")
    private String cmp_job_type;

    @SerializedName("cmp_company_address")
    private String cmp_company_address;

    @SerializedName("cmp_about_company")
    private String cmp_about_company;

    @SerializedName("cmp_link")
    private String cmp_link;

    @SerializedName("emp_size")
    private String emp_size;

    @SerializedName("cmp_state")
    private String cmp_state;

    public OtherCompaniesFrgValues(){

    }

    public OtherCompaniesFrgValues(String cmp_date_time,String cmp_uniq_id,String cmp_id,String cmp_candidate_view,
                                   String cmp_full_name,String cmp_contact,String cmp_designation,String cmp_email,
                                   String cmp_company_name,String cmp_head_office_location,String cmp_industry,
                                   String cmp_company_category,String cmp_job_type,String cmp_company_address,
                                   String cmp_about_company,String cmp_link,String emp_size,String cmp_state){

        this.cmp_date_time=cmp_date_time;
        this.cmp_uniq_id=cmp_uniq_id;
        this.cmp_id=cmp_id;
        this.cmp_candidate_view=cmp_candidate_view;
        ...
        this.cmp_state=cmp_state;
    }

    public String getCmp_date_time() {
        return cmp_date_time;
    }

    public void setCmp_date_time(String cmp_date_time) {
        this.cmp_date_time = cmp_date_time;
    }
    ...
    public String getCmp_candidate_view() {
        return cmp_candidate_view;
    }

    public void setCmp_candidate_view(String cmp_candidate_view) {
        this.cmp_candidate_view = cmp_candidate_view;
    }
    ...
    public void setCmp_link(String cmp_link) {
        this.cmp_link = cmp_link;
    }
    ...
    public void setCmp_state(String cmp_state) {
        this.cmp_state = cmp_state;
    }
