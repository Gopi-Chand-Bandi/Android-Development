...
import com.abc.justjob.ApiFile.OtherCompanies.OtherCompaniesFrgAdapter;
import com.abc.justjob.ApiFile.OtherCompanies.OtherCompaniesFrgValues;
...
public class OtherCompaniesFragment extends Fragment {
    ...
    private OtherCompaniesFrgAdapter adapter,adapter2;
    private List<OtherCompaniesFrgValues> list = new ArrayList<>(),searchlist = new ArrayList<>();

    int limit=8;
    int offset=0;

    private static final String url_product_limit = "https://justjobshr.com//JustJobApi/JustJob/Company/cmp_fetch.php?apicall=CompanyInfofetch&limit=";
    private static final String url_product_search = "https://justjobshr.com//JustJobApi/JustJob/Company/cmp_fetch.php?apicall=CompanyInfofetchWithSearch&newText=";

    public OtherCompaniesFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_other_companies,container,false);

        searchView = view.findViewById(R.id.other_companies_home_search_view);

        nestedScrollView=view.findViewById(R.id.other_companies_nested_scroll_view);
        progressBar=view.findViewById(R.id.progress_bar_other_companies);
        swipeRefreshLayout=view.findViewById(R.id.swipe_refresh_layout_other_companies_frg);
        allCompaniesRecyclerView=view.findViewById(R.id.other_companies_recycler_view);
        allCompaniesRecyclerView2=view.findViewById(R.id.other_companies_recycler_view2);
        emptyLayout=view.findViewById(R.id.empty_layout_other_companies_activity);
        shimmerFrameLayout=view.findViewById(R.id.shimmerFrameLayout_other_companies);
        ...
        adapter = new OtherCompaniesFrgAdapter(list,getContext(),true);
        adapter2 = new OtherCompaniesFrgAdapter(searchlist,getContext(),true);
    ...
    private void getDataListSearch(String newText,int limit,int offset) {
        StringRequest stringRequest = new StringRequest(Request.Method.GET,
                url_product_search + newText+ "&limit=" + limit +  "&offset=" + offset + "&cmpRegId" + cmpRegId,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                searchlist.add(new OtherCompaniesFrgValues(
...
//                      progressBar.setVisibility(View.GONE);
    ...
    private void getDataListWithLimit(int limit, int offset){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET,
                url_product_limit + limit + "&offset=" + offset + "&cmpRegId" + cmpRegId,
                new com.android.volley.Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                list.add(new OtherCompaniesFrgValues(
                                        userObject.getString("cmp_date_time"),
                                        userObject.getString("cmp_uniq_id"),
                                        userObject.getString("cmp_id"),
                                        userObject.getString("cmp_candidate_view"),
